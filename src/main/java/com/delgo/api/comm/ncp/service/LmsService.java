...
public class LmsService {
    ...
    public SmsResponseDTO sendLMS(String recipientPhoneNumber, String subject, String content) throws JsonProcessingException, UnsupportedEncodingException, InvalidKeyException, NoSuchAlgorithmException, URISyntaxException {
        Long time = System.currentTimeMillis();
        String timeStamp = time.toString();
        List<LmsMessageDTO> messages = new ArrayList<>();
        messages.add(new LmsMessageDTO(recipientPhoneNumber, subject, content));
        LmsRequestDTO lmsRequestDTO = new LmsRequestDTO("LMS", "COMM", "82", sendFrom, "[Delgo]", messages);
        ObjectMapper objectMapper = new ObjectMapper();
        String jsonBody = objectMapper.writeValueAsString(lmsRequestDTO);
        ...
        restTemplate.setErrorHandler(new DefaultResponseErrorHandler(){
            public boolean hasError(ClientHttpResponse response) throws IOException {
                ...
                System.out.println("SendLMS StatusCode: " + statusCode);
        ...
        System.out.println("SendLmsResponseDTO: " + smsResponseDTO);
